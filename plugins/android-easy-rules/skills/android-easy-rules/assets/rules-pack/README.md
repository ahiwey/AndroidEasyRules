...
插件导入会同时融合中文 Karpathy 行为准则，帮助代理在编码、文档、资料整理、表格、调研、评审、重构和修复任务中先澄清假设、保持简洁、精准修改并给出可验证成功标准。
...
5. 对主应用模块复制并适配 `android-app-AGENTS.template.md` 到该模块目录的 `AGENTS.md`。
...
| `karpathy-guidelines.md` | 中文 Karpathy 行为准则，约束澄清、简洁、精准修改和验证闭环 |
...
- 非琐碎编码、文档、资料整理、表格、调研、评审、重构和修复任务建议保留 `karpathy-guidelines.md`，让代理先确认假设和成功标准。
